sap.ui.define([
	...
	return Controller.extend("recn.RECN.controller.BuildingsView", {
		...
		onPress: function (e) {
			...
			this.getOwnerComponent().getRouter().navTo("TargetBuildingDetailView", {
				objectId: oItem.getBindingContext("contractModel").getProperty("ObjectID").toString().split("/").join(" ")
			});
		}
